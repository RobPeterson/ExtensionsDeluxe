...
namespace BitmapExtensions
{
    ...
    public static class BitmapSteganographyExtensions
    {
        ...
        /// <summary>
        /// This will steganographically embed text into an image.
        /// </summary>
        ...
        /// <summary>
        /// This will extract text from a bitmap that has been stegnographically encoded on the bit map using the
        /// algorithym in encodeText.
        /// </summary>
        /// <param name="bmp"></param>
        /// <returns></returns>
            ...
            for (var i = 0; i < bmp.Height; i++)
            {
                ...
                for (var j = 0; j < bmp.Width; j++)
                {
                    ...
                    for (var n = 0; n < 3; n++)
                    {
                        ...
                        extractedText += c.ToString(CultureInfo.InvariantCulture);
                    }
                }
            }
